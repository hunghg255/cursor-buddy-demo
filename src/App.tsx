...
function App() {
  return (
    <main>
      <header className="topbar"><a href="#">cursor buddy<span>✳</span></a><span>Bốn gương mặt, một hội bạn.</span></header>
      ...
      <section className="buddies" aria-label="Bốn cursor buddy từ ảnh của bạn">
