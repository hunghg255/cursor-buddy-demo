...
const buddies = [
  ...
  { id: 'nolan', name: 'Nolan', detail: 'Thêm một nụ cười cho cả hội', color: '#dfeee9' },
]

function App() {
  return (
    <main>
      <header className="topbar"><a href="#">cursor buddy<span>✳</span></a><span>Sáu gương mặt, một hội bạn.</span></header>
      ...
      <section className="buddies" aria-label="Sáu cursor buddy từ ảnh của bạn">
